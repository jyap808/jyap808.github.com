...
An interesting story found on Hacker News where a VPS running on Linode was compromised.  Most interesting was Marek's "support ticket log":http://pastebin.com/UW7iT5fj since it sounds like he it well versed technically.  Here is some of my analysis and thoughts.
...
Linode should immediately disable root password resets through the Linode Manager.  Root passwords should only reset by a customer service representative and only after the authorized user for that Linode has been confirmed.
