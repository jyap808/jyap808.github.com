---
layout: page
title: Certified Mac Wallet Builds Program
---
...
The coin development team may then distribute an installer file for the Mac Wallet to your end users.  Your end users can download and use your Mac Wallet with confidence that it has been built by a trusted member of the community and is *malware free*.

My aim as with all my cryptocurrency endeavors is to raise the level of *professionalism* and security in *cryptocurrency*.

If you are an end user you should *request your coin develpment team* provide you with certified Mac Wallet builds so you can buy/sell/trade your favorite coins with confidence.
